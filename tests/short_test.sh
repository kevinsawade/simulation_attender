...
python ../simulation_attender/simulation_attender.py --help
python ../simulation_attender/simulation_attender.py collect test_sims/
python ../simulation_attender/simulation_attender.py template --command "gmx mdrun -deffnm {{ stem }}"
python ../simulation_attender/simulation_attender.py submit -cm local
python ../simulation_attender/simulation_attender.py run -cm local
